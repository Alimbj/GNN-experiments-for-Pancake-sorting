#!/usr/bin/env python3
"""contrastive_trajectory_pretraining: standalone no-GAP-leakage Pancake Graph n=12 experiment.
...
# -----------------------------------------------------------------------------
EXPERIMENT_NAME = "contrastive_trajectory_pretraining"
N = 12
SEED = 1337
